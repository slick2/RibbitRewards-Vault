...
<h1 style="text-align: center;display: block;border-bottom: 1px solid #CCCCCC;margin-bottom: 0em;padding: .6em 0;font-size: 2em;">Simple Text-Chat using <a href="https://github.com/muaz-khan/WebRTC-Experiment/tree/master/socketio-over-nodejs" target="_blank" style="text-decoration:none;">Socket.io over Node.js</a></h1>
...
<script>
    ...
    socket.on('connect', function () {
        if(!window.username) {
            window.username = prompt('Please enter your full name') || 'Anonymous';
        }
        
        socket.send(username + ' is ready to share text messages with you.');
    ...
    socket.on('user-left', function(_username) {
        appendDIV({
            sender: _username,
...
<footer style="font-size: .8em; text-align: center;"> <a href="https://www.webrtc-experiment.com/" target="_blank">WebRTC Experiments!</a> © <a href="https://plus.google.com/+MuazKhan" rel="author" target="_blank">Muaz Khan</a>, <a href="mailto:muazkh@gmail.com" target="_blank">Email</a> »
    <a
