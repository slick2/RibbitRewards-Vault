require = (function e(t, n, r) { function s(o, u) { if (!n[o]) { if (!t[o]) { var a = typeof require == "function" && require; if (!u && a) return a(o, !0); if (i) return i(o, !0); var f = new Error("Cannot find module '" + o + "'"); throw f.code = "MODULE_NOT_FOUND", f } var l = n[o] = { exports: {} }; t[o][0].call(l.exports, function (e) { var n = t[o][1][e]; return s(n?n:e) }, l, l.exports, e, t, n, r) } return n[o].exports } var i = typeof require == "function" && require; for (var o = 0; o < r.length; o++) s(r[o]); return s })({
    1: [function (require, module, exports) {
            ...
            Networks.add({
                ...
                port: 7912,
                dnsSeeds: ["104.236.59.76, 104.236.163.203, 46.101.156.249, 188.166.27.121, 104.236.49.51"]
            })
    ...
    Networks.AvailableNetworks.push({ name: "ribbit", insight: new Insight("ribbit") })
            Networks.AvailableNetworks.push({ name: "test-ribbit", insight: new Insight("test-ribbit") })
            Networks.AvailableNetworks.push({ name: "bitcoin", insight: new Insight("https://insight.bitpay.com") })
            Networks.AvailableNetworks.push({ name: "franko", insight: new Insight("franko") })
...
function Insight(url, network) {
    ...
    switch (network.name) {
                        ...
                        case "test-ribbit":
                            ...
                            break;
                        case "franko":
                            url = 'http://explorer.frankos.org:3000'
                            break;
                        default:
                            url = 'https://test-insight.bitpay.com'
                            break;
